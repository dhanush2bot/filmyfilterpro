...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 InlineKeyboardButton('Jᴏɪɴ Cʜᴀɴɴᴇʟ', url="https://t.me/filmyspotmovie"),
                 InlineKeyboardButton("Vɪᴇᴡ Sᴛᴀᴛᴜs", url=f"{query.message.link}")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('HOW ITS WORK', url="https://t.me/filmyspotupdate"), 
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')    
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://graph.org/file/2b8a4375ed3bee8a5b5d7.jpg")
        ) 
        await query.message.edit_text(
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://graph.org/file/6b9d57f76de3f231b6002.jpg")
        ) 
        await query.message.edit_text(
        ...
        buttons = [
            InlineKeyboardButton('𝐒𝐄𝐍𝐃 𝐒𝐂𝐑𝐄𝐄𝐍𝐒𝐇𝐎𝐓', url="https://t.me/FilmySpotSupport_bot"), 
            InlineKeyboardButton('𝐇𝐎𝐖 𝐈𝐓𝐒 𝐖𝐎𝐑𝐊', url="https://t.me/filmyspotupdate") 
        ],[
            InlineKeyboardButton('📃 𝐂𝐇𝐄𝐂𝐊 𝐏𝐋𝐀𝐍𝐒 📃', callback_data='check')
        ],[
            InlineKeyboardButton('💸 𝐌𝐀𝐊𝐄 𝐀 𝐏𝐀𝐘𝐌𝐄𝐍𝐓 💸', url="https://cosmofeed.com/vig/657538fb2e3f6b001e3cc0c0")
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="◆ ◇ ◇"
...
async def auto_filter(client, msg, spoll=False):
    ...
    # else:
    #     btn.insert(0, [
    #         InlineKeyboardButton('❗❗  ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ  ❗❗', url="https://t.me/filmyspotupdate")
    #     ])
        btn.insert(0, [
            InlineKeyboardButton("𝐒𝐞𝐧𝐝 𝐀𝐥𝐥", callback_data=f"sendfiles#{key}")
        ])
    ...
    if imdb:
        ...
        if settings["button"]:
            cap = f"<b>🎬 Tɪᴛʟᴇ : {search}\n\n📂 Fɪʟᴇꜱ : {total}\n\n⏰ Rᴇsᴜʟᴛ Sʜᴏᴡɴ Iɴ : {remaining_seconds} <i>seconds 🔥</i>\n\n📝 Rᴇǫᴜᴇsᴛᴇᴅ Bʏ : {query.from_user.mention}\n\n⚜️ Pᴏᴡᴇʀᴇᴅ Bʏ : <a href=https://t.me/filmyspotmovie>𝐅𝐢𝐥𝐦𝐲𝐒𝐩𝐨𝐭</a></b>"
        else:
